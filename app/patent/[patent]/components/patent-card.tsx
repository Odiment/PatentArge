...
/*     let patentResimler_resim_url = patentResimler.map(
  ...
  if ((url === null) || (url === undefined)) {
    resim_url =
      "https://qzxxwmyywwqvbreysvto.supabase.co/storage/v1/object/sign/patentFigure/format.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwYXRlbnRGaWd1cmUvZm9ybWF0LnBuZyIsImlhdCI6MTY5ODkxMTgyNywiZXhwIjoxNzkzNTE5ODI3fQ.JfCgz_bENNfR4r56X4u5IuNjg6qo7ylluttM8f14CFg&t=2023-11-02T07%3A57%3A08.180Z";
    /* resim_url =
