            ...
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem
                  key="patentdetay"
                  onClick={() => {
                    onNavigate(`/patentdetay/${user.referans_no}`)
                  }}
                >
                  Patent Detayları
                </DropdownItem>
                <DropdownItem
                  key="patentdetay"
                  onClick={() => {
                    onNavigate(`/ptcard/${user.referans_no}`)
                  }}
                >
                  Düzenle
                </DropdownItem>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          <Input
            ...
            placeholder="Buluş başlığıyla arama yapabilirsiniz..."
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Toplam {veri.length} adet patent
          </span>
        </div>
      </div>
    )
