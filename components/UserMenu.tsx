    ...
    <div className="flex items-center gap-4">
      <Dropdown placement="bottom-start " className='bg-primary'>
        ...
        <DropdownMenu aria-label="User Actions" variant="flat">
          ...
          <DropdownItem key="settings" className='text-background'>Profilim</DropdownItem>
          ...
          <DropdownItem key="help_and_feedback" className='text-background'>Yardım & Geri Bildirim</DropdownItem>
          <DropdownItem
